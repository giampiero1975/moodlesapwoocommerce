...
$sql = "INSERT INTO `invoice` (`mdl`, `userid`, `courseid`, `cardcode`, `cardname`, `codicefiscale`, `partitaiva`, `nfattura`, `moodle_payment_id`)" .
    ...
    public function invoicePdf()
    {
        try {
            ...
            $pdf->datifatt("Codigo del cliente: " . $this->BPSAP['cardcode'], "N�mero de valor agregado : " . $this->BPSAP['partitaiva'], "C�d. Fisc. : " . $this->BPSAP['AddId']);
            ...
            $line = array(
                ...
                "DESCRIPCI�N" => $this->datiInvoice['descrart1'] . "\n" .$this->userMoodle['0']['Rag'],
                "CANT." => "1",
            ...
            if ($this->bollo) {
                ...
                $line = array(
                    ...
                    "DESCRIPCI�N" => $this->datiInvoice['descrbollo'],
                    "CANT." => "1",
            ...
            $pdf->Cell(0, 10, 'Condici�n de pago COMPLETADA', 0, 0, 'L');
            ...
            if (! empty($this->userMoodle['0']['email'])) {
                ...
                $mess = '<br>Le enviamos la factura relativa al curso ' . $config::MAILBOXES[$this->mdl]['corso'] . '.<br>Un saludo,<br>Secretaria administrativa Medical Evidence - Divisi�n de Marketing & Telematica Espa�a, S.L.';
