...
define('WP_DB_HOST', 'db.mei-bu.cloud'); // Host comune DB WordPress
define('WP_DB_USER', 'wordpress');    // Utente comune DB WordPress
define('WP_DB_PASS', '$$!.w0rDpr3sS.!$$'); // Password comune DB WordPress

// Credenziali per accedere ai database Moodle (devono avere accesso a tutti i DB Moodle elencati sotto)
define('MOODLE_DB_HOST', 'db.mei-bu.cloud'); // Host comune DB Moodle
define('MOODLE_DB_USER', 'moodle');       // Utente comune DB Moodle
define('MOODLE_DB_PASS', 'RmnPbT78');    // Password comune DB Moodle
...
define('WC_INSTANCE_MAPPING', [
    ...
    '{MV}' => [ // Prefisso per la seconda istanza WC
        'wc_db_name'   => 'wp_mei', // Esempio: DB WP per MeiOSS
        'wc_db_prefix' => 'wpmei_34_',      // Esempio: Prefisso tabelle per Prof.Farmacia
        'moodle_db_name' => 'mdl_missioneveterinario', // DB Moodle associato
        'cf_meta_key'    => 'cf_user'
    ],
...
define('SMTP_PASS', '986Met$020!!'); // Password SMTP <- SOSTITUISCI!
